...
#show: template.with(title: "A Paper With Keywords", author: ((name: "Iva Po", markers: ()),), affiliation: none, columns: 1, date: none, equations: "plain", figures: "sectioned", headings: "2", citations: "numeric")
