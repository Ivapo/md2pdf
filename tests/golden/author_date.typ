...
#show: template.with(title: "Reading in the sentence", author: none, affiliation: none, columns: 1, date: none, equations: "plain", figures: "flat", headings: "plain", citations: "author-date")
