...
#show: template.with(title: "Acme Ships md2pdf 1.0", author: ((name: "Iva Po", markers: ()),), affiliation: none, columns: 1, date: "10 August 2026", equations: "plain", figures: "flat", headings: "plain")
