...
#show: template.with(title: "A Minimal Example", author: ((name: "Iva Po", markers: ()),), affiliation: none, columns: 1, date: none, equations: "plain", figures: "flat", headings: "plain", citations: "numeric")
