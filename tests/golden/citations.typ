...
#show: template.with(title: "Citing a source", author: none, affiliation: none, columns: 1, date: none, equations: "plain", figures: "flat", headings: "plain", citations: "numeric")
