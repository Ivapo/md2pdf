...
// title, author, columns and date. That is the contract a third look has to
// meet. The defaults below are the fallback for a hand-written call;
// core/src/frontmatter.rs holds the ones a document actually gets.

#let template(title: none, author: none, columns: 2, date: none, doc) = {
