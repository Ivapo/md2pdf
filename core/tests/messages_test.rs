...
fn every_variant(place: impl Fn(usize) -> Location) -> Vec<Error> {
    vec![
        ...
        Error::Diagram {
            location: place(4),
            problem: "diagram type 'gantt' is not supported; the supported types are flowchart, graph, sequenceDiagram, classDiagram, classDiagram-v2, stateDiagram, stateDiagram-v2 and erDiagram".to_string(),
        },
        Error::Name {
            location: place(9),
...
fn every_variant_prints_the_sentence_it_always_printed() {
    let expected = [
        ...
        "diagram error at line 4: diagram type 'gantt' is not supported; the supported types are flowchart, graph, sequenceDiagram, classDiagram, classDiagram-v2, stateDiagram, stateDiagram-v2 and erDiagram",
...
fn every_variant_names_the_file_where_there_is_one() {
    let expected = [
        ...
        "diagram error in sections/method.md at line 4: diagram type 'gantt' is not supported; the supported types are flowchart, graph, sequenceDiagram, classDiagram, classDiagram-v2, stateDiagram, stateDiagram-v2 and erDiagram",
