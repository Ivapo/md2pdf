...
user's markdown — "One markdown file, or a master and the sections it names, plus the
images they name, single PDF out."** Every phase says whether it produces one; a phase
